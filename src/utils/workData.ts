// src/utils/workData.ts

const workData = [
  {
    title: "Web platform to visualize and manage physical models",
    image: ["/assets/works/isover.gif"],
    description:
      "A web app, written in Flask and React, with Celery, Postgres, Tailwind to visualize and manage physical models for materials plants",
    tags: ["FastAPI", "postgresql", "React.js", "Tailwind", "Web"],
  },
  {
    title: "MyPerfMgr",
  ...
  {
    title: "Party Game on mobile",
    image: ["/assets/works/partybox.png"],
    description: "Party game on Google Play Store, written in React Native",
    tags: ["FastAPI", "postgresql", "React.js", "Tailwind", "Web"],
  },
  {
